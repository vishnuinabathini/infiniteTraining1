...
public class ExceptionHandlingStringChecker {

   static class StringChecker {
        public void divideByStringLength() {
            String[] sarr = {"Hi", "hello", "vishnuSSVT","SriSaanvitha"};
            int[] numarr = {1, 0, 5};
            try {
                for (int i = 0; i < numarr.length; i++) {
                    System.out.println("value:" + numarr[i + 1] / sarr.length);
                  //  System.out.println("number array length = " + numarr.length);
       ...
       public static void main(String[] args) {
           ...
           try {
             ...
             //  System.out.println("StringLength = "+checker);
           }
