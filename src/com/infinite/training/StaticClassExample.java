...
class Ford {
    ...
    static{
        ...
        System.out.println("noOfCars sold today = " + noOfCars);
    }
    ...
    public static void main(String[] args) {
        ...
        Ford.orderCar("vitara","ash");
        System.out.println(" booked vitara" +Ford.orderCar("vitara","ash"));
        Ford f4 = new Ford("vitaraGrand","ash");
        System.out.println("f4.noOfCars = " + f4.noOfCars);
        System.out.println("booked car is " + f4.modelNo);
        System.out.println("carcolor is " + f4.color);
    }
}
